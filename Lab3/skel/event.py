...
class Master(Thread):
    ...
    def get_work(self):
        print "get_work nume: " + self.name + "get_work self: " + str(current_thread()) + "get_work thread: " + str(self.work)
        return self.work
...
class Worker(Thread):
    ...
    def get_result(self):
        print "get_result nume: " + self.name + "get_result self: " + str(current_thread()) + "get_result thread: " + str(self.result)
        return self.result
